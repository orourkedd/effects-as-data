...
var _require14 = require('./test/pipes/interpolate');

var interpolationTest = _require14.interpolationTest;

var _require15 = require('ramda');

var merge = _require15.merge;
...
describe('effects-as-data', function () {
  ...
  describe('run', function () {
    ...
    describe('interpolate', function () {
      it('should run pipe without interpolation', function () {
        return run({}, interpolationTest, { doInterpolation: false }).then(function (state) {
          deep(state.payload.value, 3);
        });
      });

      it('should iterpolate pipe segment and pass state through', function () {
        return run({}, interpolationTest, { doInterpolation: true }).then(function (state) {
