...
const { cacheGet, httpGet, cacheSet, log, logError } = require('../actions')
const { success, failure, errorToObject } = require('../../util')
...
describe('demo/users.js', () => {
  describe('#getUsers', () => {
    describe('if cache hit', () => {
      it(
        'should return value from cache on cache hit and log cache hit',
        testGetUsers(() => {
          //  prettier-ignore
          return [
            [null, cacheGet('users')],
    ...
    describe('if cache miss', () => {
      describe('if user GET success', () => {
        it(
          'should GET users and set cache',
          testGetUsers(() => {
            //  prettier-ignore
            return [
              [null, cacheGet('users')],
        ...
        describe('if cache set failure', () => {
          it(
            'should log error and return result',
            testGetUsers(() => {
      ...
      describe('if user GET failure', () => {
        it(
          'should log error and return failure object',
          testGetUsers(() => {
