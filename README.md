...
[src/actions/node/env.js:33-37](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/node/env.js#L33-L37 "Source code on GitHub")
...
[src/actions/node/fs.js:37-44](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/node/fs.js#L37-L44 "Source code on GitHub")

Creates a `readFile` action.  `yield` a `readFile` action to read a file using `fs.readFile`.

**Parameters**

-   `file` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** path
...
[src/actions/node/fs.js:84-91](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/node/fs.js#L84-L91 "Source code on GitHub")
...
[src/actions/node/prompt.js:35-40](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/node/prompt.js#L35-L40 "Source code on GitHub")

Creates a `prompt` action.  `yield` a `prompt` action read input form a user from the command line.

**Parameters**

-   `prompt` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** for the user
-   `question`  
...
[src/actions/node/require-module.js:35-40](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/node/require-module.js#L35-L40 "Source code on GitHub")
...
[src/actions/universal/call.js:43-50](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/call.js#L43-L50 "Source code on GitHub")
...
-   `an` **[Function](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/function)** effects-as-data generator function.
...
[src/actions/universal/echo.js:35-40](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/echo.js#L35-L40 "Source code on GitHub")
...
-   `the` **any** value to be returns from the handler.
-   `payload`  
...
[src/actions/universal/guid.js:33-37](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/guid.js#L33-L37 "Source code on GitHub")
...
[src/actions/universal/http.js:43-50](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/http.js#L43-L50 "Source code on GitHub")

Creates a `httpGet` action.  `yield` an `httpGet` action to do an http GET request.

**Parameters**

-   `the` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** url to GET.
...
[src/actions/universal/http.js:89-97](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/http.js#L89-L97 "Source code on GitHub")

Creates a `httpPost` action.  `yield` an `httpPost` action to do an http POST request.

**Parameters**

-   `the` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** url to POST.
...
[src/actions/universal/http.js:136-144](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/http.js#L136-L144 "Source code on GitHub")

Creates a `httpPut` action.  `yield` an `httpPut` action to do an http PUT request.

**Parameters**

-   `the` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** url to PUT.
...
[src/actions/universal/http.js:181-188](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/http.js#L181-L188 "Source code on GitHub")

Creates a `httpDelete` action.  `yield` an `httpDelete` action to do an http DELETE request.

**Parameters**

-   `the` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** url to DELETE.
-   `headers` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)?** request headers. (optional, default `{}`)
-   `options` **[Object](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object)?** options for `fetch`. (optional, default `{}`)
-   `url`  
...
[src/actions/universal/json-parse.js:35-40](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/json-parse.js#L35-L40 "Source code on GitHub")
...
-   `the` **[string](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)** JSON string to parse.
-   `payload`  
...
[src/actions/universal/log.js:35-40](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/log.js#L35-L40 "Source code on GitHub")
...
[src/actions/universal/log.js:76-81](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/log.js#L76-L81 "Source code on GitHub")
...
[src/actions/universal/now.js:33-37](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/now.js#L33-L37 "Source code on GitHub")
...
[src/actions/universal/random-number.js:33-37](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/random-number.js#L33-L37 "Source code on GitHub")
...
[src/actions/universal/state.js:34-39](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/state.js#L34-L39 "Source code on GitHub")

Creates a `getState` action.  `yield` a `getState` to get application state.

**Parameters**

-   `an` **[Array](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array)** array of paths to sections of state.  For example, ['user.firstName', 'settings.showBanner']
-   `keys`  
...
[src/actions/universal/state.js:76-81](https://github.com/orourkedd/effects-as-data/blob/0eafe4416903d540efc49a4c0e287fcd30423bbf/src/actions/universal/state.js#L76-L81 "Source code on GitHub")
